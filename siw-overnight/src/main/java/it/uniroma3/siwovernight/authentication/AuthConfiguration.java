    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests( authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/","/register","/login","/artisti/**","/eventi/**","/locali/**","/search","/error","/css/**","/images/**","favicon.ico").permitAll()
                        // chiunque (autenticato o no) puÃ² mandare richieste POST al punto di accesso per login e register
                        .requestMatchers(HttpMethod.POST, "/register","/login","/artisti/**","/eventi/**","/locali/**","/searchArtista","/searchEvento","/searchLocale").permitAll()
